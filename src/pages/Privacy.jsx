...
const PrivacyPolicy = () => {
  return (
    <div className="container mt-5">
      ...
      <h3 className="mt-4">Interpretation and Definitions</h3>
      ...
      <ul>
        ...
        <li>
          ...
          "Us" or "Our" in this Agreement) refers to Smart Enterprises,
          Mullanpara, Manjeri, Kerala, India 676121.
        </li>
        <li>
        ...
        <li>
          <strong>Website</strong> refers to www.warriorind.in, accessible from
          www.warriorind.in
        </li>
        <li>
      ...
      <h3 className="mt-4">Collecting and Using Your Personal Data</h3>
      ...
      <h3 className="mt-4">Tracking Technologies and Cookies</h3>
      <p>
      ...
      <h3 className="mt-4">Use of Your Personal Data</h3>
      ...
      <h3 className="mt-4">Other Legal Requirements</h3>
      <p>
      ...
      <h3 className="mt-4">Security of Your Personal Data</h3>
      <p>
      ...
      <ul>
        <li>
          By email: <a href="mailto:info@warriorind.in">info@warriorind.in</a>
        </li>
      </ul>
    </div>
  );
