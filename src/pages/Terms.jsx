...
const TermsAndConditions = () => {
  return (
    <Container className="mt-4">
      <Row>
        <Col>
          <h1 className="text-start">Terms and Conditions</h1>
          ...
          <ul>
            ...
            <li>
              ...
              "We", "Us" or "Our" in this Agreement) refers to Smart
              Enterprises, Mullanpara, Manjeri, Kerala, India 676121.
            </li>
            <li>
            ...
            <li>
              ...
              <a href="http://www.warriorind.in">www.warriorind.in</a>,
              accessible from www.warriorind.in.
            </li>
            <li>
          ...
          {/* Additional sections like Limitation of Liability, Disclaimer, Governing Law, etc., follow similar structure */}
          ...
          <h2 className="mt-4 mb-3">"AS IS" and "AS AVAILABLE" Disclaimer</h2>
          <p>
          ...
          <h2 className="mt-4 mb-3">Governing Law</h2>
          <p>
          ...
          <h2 className="mt-4 mb-3">Disputes Resolution</h2>
          <p>
          ...
          <h2 className="mt-4 mb-3">For European Union (EU) Users</h2>
          <p>
          ...
          <h2 className="mt-4 mb-3">United States Legal Compliance</h2>
          <p>
          ...
          <h2 className="mt-4 mb-3">Severability and Waiver</h2>
          <h3 className="mt-3">Severability</h3>
          <p>
          ...
          <h2 className="mt-4 mb-3">Translation Interpretation</h2>
          <p>
          ...
          <h2 className="mt-4 mb-3">Changes to These Terms and Conditions</h2>
          <p>
          ...
          <ul>
            <li>
              ...
              <a href="mailto:info@warriorind.in">info@warriorind.in</a>
            </li>
          </ul>
        </Col>
      </Row>
